return {
  ...
  apply(ctx) {
    ...
    function playerSrc(video) {
      return 'https://player.bilibili.com/player.html?bvid=' + video.bvid +
    ...
    function BiliWatch(props) {
      ...
      if (pending) {
        ...
        derived = { reason: 'completed', at: 'completed:' + Date.now(), message: null, source: 'session' }
      }
      ...
      if (attention) {
        ...
        const msg = attention.message
          ? el('div', { className: 'bw-msg' }, String(attention.message))
          : null
