return {
  ...
  apply(ctx) {
    ...
    styles.insert(`
      ...
      .bw-rel { width: 118px; flex: none; background: rgba(255,255,255,.04); border: 1px solid rgba(255,255,255,.08); border-radius: 8px; overflow: hidden; cursor: pointer; padding: 0; color: #fff; text-align: left; }
      .bw-rel:hover { border-color: rgba(251,114,153,.55); }
